	Computer_System u0 (
		...
		.telemetre_ex_distance      (<connected-to-telemetre_ex_distance>),      //         telemetre_ex.distance
		.telemetre_ex_trig          (<connected-to-telemetre_ex_trig>),          //                     .trig
		.telemetre_ex_echo          (<connected-to-telemetre_ex_echo>),          //                     .echo
		.servomoteur_ex_commande    (<connected-to-servomoteur_ex_commande>)     //       servomoteur_ex.commande
	);
